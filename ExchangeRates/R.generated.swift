...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image ` float`.
    static let float = Rswift.ImageResource(bundle: R.hostingBundle, name: " float")
    /// Image ` link`.
    ...
    /// `UIImage(named: " float", bundle: ..., traitCollection: ...)`
    static func float(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.float, compatibleWith: traitCollection)
    }
  ...
  struct string {
    ...
    struct localizable {
      ...
      /// en translation: Щукати
      /// 
      /// Locales: en
      static let find = Rswift.StringResource(key: "find", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en"], comment: nil)
      /// en translation: м. 
      /// 
      /// Locales: en
      ...
      /// 
      /// Locales: en
      static func find(_: Void = ()) -> String {
        return NSLocalizedString("find", bundle: R.hostingBundle, comment: "")
      }
