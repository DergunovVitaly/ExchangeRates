...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if #available(iOS 11.0, *) {
          if UIKit.UIColor(named: "lightBlue", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'lightBlue' is used in storyboard 'Main', but couldn't be loaded.") }
        }
      }
